...
def td_learning(env, approximator_0, approximator_2048, num_episodes=50000, alpha_0=0.01, alpha_2048=0.16, gamma=0.99, epsilon=0.1):
    ...
    for episode in range(num_episodes):
        ...
        if (episode + 1) % 1000 == 0:
            weight_filename = os.path.join(weights_0_dir, f"weights_{episode+1}_5.pkl")
            save_weights(approximator_0, weight_filename)
            print(f"Saved weights to {weight_filename}")
            
            weight_filename = os.path.join(weights_2048_dir, f"weights_{episode+1}_5.pkl")
...
def train(approx_0, approx_2048):
    env = Game2048Env()
    final_scores = td_learning(env, approx_0, approx_2048, num_episodes=10000, alpha_0=0.32, alpha_2048=0.48, gamma=0.99, epsilon=0.1)
...
if __name__ == "__main__":
    ...
    weight_0_path = "weights/weights_10000_4.pkl"
